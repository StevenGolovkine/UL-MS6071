...
To create a new app, in RStudio, we could go to *New File > Shiny Wep App...*. In the pop-up window (@fig-shiny-app), put a name, make sure that *Multiple File* is clicked, choose a folder and click on *Create*.
