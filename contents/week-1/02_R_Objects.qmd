...
Let's look at an example to understand how it works. First, we create a simple vector of length $10$. 
...
For example, to create a new class for a simple vector and override the `print` function.
