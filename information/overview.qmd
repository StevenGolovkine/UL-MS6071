...
- equip students with advanced proficiency in the R programming language.

- provide in-depth knowledge of data manipulation techniques using R packages.

- choose the appropriate R package to deal with the situation they face.

- cultivate expertise in data visualization principles and advanced plotting.
...
- learn some usages and limitations of Large Language Models for R.
