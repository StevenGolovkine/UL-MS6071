---
title: "Code debugging and profiling"
editor: visual
---

Code debugging and profiling are important tasks in the development and optimisation of scripts and applications. Debugging involves identifying and resolving errors, ensuring the code functions as intended, and addressing issues that may lead to runtime errors. Profiling, on the other hand, involves assessing the code performance, understanding resource usage, and identifying bottlenecks to enhance efficiency.
...
⌨️ [Solution proposal](/labs/solutions/week-9.R)
