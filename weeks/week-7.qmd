...
Before starting reading the materials, download the data from [here](https://www.kaggle.com/datasets/wenxingdi/data-expo-2009-airline-on-time-data) and unzip it somewhere on your laptop.
